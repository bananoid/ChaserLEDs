...
#define AUDIO_IN_MID_PIN 27   //A12
#define AUDIO_IN_HIGH_PIN 26  //A13

#define AUDIO_DEBUG_WHITE_LED_PIN 9
#define AUDIO_DEBUG_WHITE_BOARD_LED_PIN 4
#define AUDIO_DEBUG_RED_LED_PIN 8
#define AUDIO_DEBUG_BLUE_LED_PIN 7
